...
@section('add-js')
  ...
  <script type="text/javascript">
    ...
    var table = $('.data-table').DataTable({
        ...
        ajax: "",
        columns: [
            {data: 'IdWarna', name: 'IdWarna'},
            {data: 'NamaWarna', name: 'NamaWarna'},
    ...
    $("#Edit").click(function(e){
        ...
        $.ajax({
            type: 'PATCH',
            url: "{{ url('/pos/pages/warnaproduk/') }}/"+a+"/",
    ...
    function edit(a){
        ...
        $.ajax({
            type: "GET",
            url: "{{ url('/pos/pages/warnaproduk/') }}/"+a+"/edit",
            data: kode,
            success: function(msg){
                $("#IdWarnaE").val(msg.IdWarna);
                $("#NamaWarnaE").val(msg.NamaWarna);
            }
        })
    }
...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Data Warna Produk</h1>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Data Warna Produk</h6>
        </div>
        <div class="card-body">
            ...
            <table class="table table-bordered data-table" width="100%" cellspacing="0">
                <thead>
                <tr>
                    <th>Id Warna Produk</th>
                    <th>Nama Warna Produk</th>
                    <th>Aksi</th>
                </tr>
                </thead>
                <tbody>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="add">Tambah Data Warna Produk</h5>
    ...
    <div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="add">Edit Data Warna Produk</h5>
                    <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form method="post" action="#" id="form-edit">
                        <input type="hidden" class="form-control" name="IdWarna" id="IdWarnaE" required>
                        <div class="form-group">
                            <label>Nama Warna Produk</label>
                            <input type="text" class="form-control" name="NamaWarna" id="NamaWarnaE" required>
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
